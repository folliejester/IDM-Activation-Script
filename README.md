...
-   It is recommended that you block access to `internetdownloadmanager.com`, `registeridm.com` and `www.internetdownloadmanager.com` before you proceed to activate.
...
-   Raise the issue on [Github](https://github.com/folliejester/IDM-Activation-Script) with screenshots.
